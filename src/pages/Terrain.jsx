...
const Terrain = () => {
  return (
    <div className="content-body information-page">
      ...
      <InformationCard sectionName="Short Distances" right={<SubCard title="Related Links" content={[<Link to={"/types"}>Types of Motorcycles</Link>, <Link to={"/popular"}>Best Beginner Motorcycles</Link>]}/>}>
        <p>
